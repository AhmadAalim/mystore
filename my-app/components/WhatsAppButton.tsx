...
export default function WhatsAppButton() {
  ...
  const whatsappNumber = "+972545088577";
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      {isHovered && (
        <div className="absolute bottom-full right-0 mb-2 bg-gray-900 text-white text-sm py-2 px-3 rounded-lg whitespace-nowrap">
          Contact Us
