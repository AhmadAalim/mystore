    ...
    <footer className="bg-gray-900 text-white mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              {/* Instagram */}
              <a
                href="https://instagram.com/naamanvardinon.km"
                target="_blank"
              ...
              {/* Facebook */}
              <a
                href="https://facebook.com/naamanvardinon.km"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* TikTok */}
              <a
                href="https://tiktok.com/@naamanvardinon.km"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Email */}
              <a
                href="mailto:byahmadaalim@gmail.com"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} All rights reserved for ahmadaalim
          </p>
        </div>
      </div>
    </footer>
